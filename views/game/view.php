        ...
        <div class="content-container">
            <div class="up-row">
                <div class="page-head-txt">
                    <h1>Игра <?= Html::encode($this->title) ?></h1>
                </div>
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return $model->genre->name; // Предполагаем, что у модели Game есть отношение 'genre' с атрибутом 'name'
                },
            ],
            [
                'attribute' => 'category',
                'value' => function ($model) {
                    return $model->category->name; // Предполагаем, что у модели Game есть отношение 'category' с атрибутом 'name'
                },
            ],
            'release_year',
            [
                'attribute' => 'developer',
                'value' => function ($model) {
                    return $model->developer->name; // Предполагаем, что у модели Game есть отношение 'developer' с атрибутом 'name'
                },
            ],
            'image',
            'created_at',
